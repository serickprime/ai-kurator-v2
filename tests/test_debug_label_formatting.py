...
def test_debug_documents_use_filename_when_title_is_generic() -> None:
    summary = _format_debug_summary(
        {
            "status": "AnswerStatus.ANSWERED",
            "sources": ["CLn02_text_double_deep"],
    ...
    assert "CLn02_text_double_deep score=1.9112" in summary
    assert "Заголовок 1" not in summary
